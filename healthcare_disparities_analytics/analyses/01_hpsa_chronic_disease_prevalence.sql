...
--              and non-designated counties across 11 conditions
...
SELECT 
    ...
    ROUND(AVG(stroke_pct), 2)           AS avg_stroke_pct,
    ROUND(AVG(asthma_pct), 2)           AS avg_asthma_pct,
    ROUND(AVG(high_cholesterol_pct), 2) AS avg_high_cholesterol_pct,
    ROUND(AVG(cancer_pct), 2)           AS avg_cancer_pct,
    ROUND(AVG(arthritis_pct), 2)        AS avg_arthritis_pct,
