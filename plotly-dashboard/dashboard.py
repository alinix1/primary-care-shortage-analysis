...
bar_data = pd.DataFrame(
    {
        ...
        "AVG_EXCESS_STAYS": [-205.1, -69, 52, 329.2],
    }
)
    ...
    children=[
            ...
            children=[
                ...
                html.Div(
                    ...
                    children=[
                        ...
                        html.H2(
                            "300+", style={"color": "#38BDF8", "margin": "4px 0 0"}
                        ),
                    ],
                ),
                html.Div(
        ...
        html.Div(
            ...
            children=[
                ...
                html.P(
                    "Counties in the highest shortage quartile average 300+ more excess stays above the national average",
                    style={
                        "color": "#64748B",
                        "fontSize": "11px",
                        "marginBottom": "8px",
